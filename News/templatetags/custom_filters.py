...
def censorship(value):
    """
    Цензурирует определенные слова в заданном тексте, заменяя их звездочками.

    Параметры:
    - value: текст для цензурирования (str)

    Возвращает:
    - censored_text: цензурированная версия текста (str)
    """
